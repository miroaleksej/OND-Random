...
- Online calibration H_rank mean: 0.9579015228976158
- Best backend (qubits=20): numpy

## OND Differentials
- H_sub(IID) - H_sub(Q-drift): 0.0319
- H_branch(IID) - H_branch(Q-drift): 0.0410
...
- n_qubits=1: mean_abs_err=3.064e-02, max_abs_err=3.064e-02
- n_qubits=2: mean_abs_err=1.232e-02, max_abs_err=2.464e-02
